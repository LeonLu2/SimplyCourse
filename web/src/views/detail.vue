        ...
        <div class="row course-head">
          ...
          <div class="col-sm-6">
            ...
            <p class="course-head-button-links">
              ...
              <a v-show="memberCourse.id" href="#" class="btn btn-lg btn-success btn-shadow disabled">signed up</a>
            </p>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <ul class="nav nav-tabs">
              <li class="nav-item">
                <a class="nav-link active" href="#info" data-toggle="tab">Course Intro</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#chapter" data-toggle="tab">Chapters</a>
              </li>
            </ul>
