        ...
        <div class="modal-body">
          <div class="login-div" v-show="MODAL_STATUS === STATUS_LOGIN">
            ...
            <div class="form-group">
              <div class="checkbox">
                <label>
                  <input type="checkbox" class="remember" v-model="remember"> remember me
                </label>
          ...
          <div class="forget-div" v-show="MODAL_STATUS === STATUS_FORGET">
            ...
            <div class="form-group">
              <input v-on:blur="onForgetMobileBlur()"
                     ...
                     class="form-control" placeholder="Phone Number">
              <span v-show="forgetMobileValidate === false" class="text-danger">Phone number is 10 digits, and must be registered</span>
            </div>
            <div class="form-group">
              <div class="input-group">
                <input v-on:blur="onForgetMobileCodeBlur()"
                       ...
                       placeholder="verification code" v-model="memberForget.smsCode">
                <div class="input-group-append">
              ...
              <span v-show="forgetMobileCodeValidate === false" class="text-danger">Please provide 6 digits verification code</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <span v-show="forgetConfirmPasswordValidate === false"
                    class="text-danger">Please provide uniform password</span>
            </div>
            <div class="form-group">
  ...
  methods: {
    ...
    sendSmsForRegister() {
      ...
      _this.$ajax.get(process.env.VUE_APP_SERVER + '/business/web/member/is-mobile-exist/' + _this.memberRegister.mobile).then((res) => {
        ...
        if (response.success) {
          Toast.warning("Phone number is already registered");
        } else {
          // 调服务端发送短信接口
