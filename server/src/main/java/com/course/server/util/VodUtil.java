...
public class VodUtil {
    ...
    public static CreateUploadVideoResponse createUploadVideo(DefaultAcsClient vodClient) throws ClientException {
        ...
        request.setCateId(10000000492L);
        request.setTemplateGroupId("f9e8ff0960d92e6cecae1eb6c1843860");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5t7as47M1DDzs4cSUDJf";
        //您的AccessKeySecret
        String accessKeySecret = "gURPV4WYUAhTyQY8azwaQmulm9DnIP";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "C:\\Users\\njlsh\\OneDrive\\桌面\\test video 2.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
